...
<aside class="sidebar">
    ...
    <div class="sidebar-nav">
        ...
        <button class="table-btn active" onclick="showTable('users')" id="btn-users">
            users <span class="count" id="cnt-users">{{ count($users) }}</span>
        </button>
        <button class="table-btn" onclick="showTable('news')" id="btn-news">
            news <span class="count" id="cnt-news">{{ count($news) }}</span>
        </button>
        <button class="table-btn" onclick="showTable('news_media')" id="btn-news_media">
            news_media <span class="count" id="cnt-news_media">{{ count($news_media) }}</span>
        </button>
        <button class="table-btn" onclick="showTable('enrollments')" id="btn-enrollments">
            enrollments <span class="count" id="cnt-enrollments">{{ count($enrollments) }}</span>
        </button>
        ...
        <button class="table-btn" onclick="showTable('migrations')" id="btn-migrations">
            migrations <span class="count" id="cnt-migrations">{{ count($migrations) }}</span>
        </button>
    </div>
        ...
        <div id="table-{{ $tableName }}" class="table-section" style="{{ $tableName !== 'users' ? 'display:none' : '' }}">
            <div class="schema-wrap">
                ...
                <div class="schema-cols">
                    @foreach($tableData['schema'] as $col)
                        <span class="schema-col {{ str_contains($col, 'PK') ? 'pk' : (str_contains($col, 'FK') ? 'fk' : '') }}">{{ $col }}</span>
                    @endforeach
                </div>
            </div>
            <div class="table-wrap">
                ...
                <div class="table-container">
                    ...
                    @else
                    <div class="empty-state">Таблица пустая</div>
                    @endif
                </div>
            </div>
        </div>
...
<script>
const tableNames = {
    'users': 'users', 'news': 'news', 'news_media': 'news_media',
    'enrollments': 'enrollments', 'migrations': 'migrations'
};
